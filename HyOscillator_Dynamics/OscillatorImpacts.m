classdef OscillatorImpacts < HybridSystem
    % A bouncing ball modeled as a HybridSystem subclass.

    % Define variable properties that can be modified.
    properties
        gamma = 9.81;  % Acceleration due to gravity.
        lambda = 0.6; % Coefficient of restitution.
        damping = 0.6;
    end
    ...
    methods 
        function this = OscillatorImpacts()
